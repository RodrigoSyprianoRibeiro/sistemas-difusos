	...
	$.extend( $.fn.dataTableExt.oPagination, {
		"bootstrap": {
			"fnInit": function( oSettings, nPaging, fnDraw ) {
				...
				var els = $('a', nPaging);
				$(els[0]).bind( 'click.DT', { action: "primeiro" }, fnClickHandler );//first
				$(els[1]).bind( 'click.DT', { action: "anterior" }, fnClickHandler );//next
				$(els[2]).bind( 'click.DT', { action: "próximo" }, fnClickHandler );//prev
				$(els[3]).bind( 'click.DT', { action: "último" }, fnClickHandler );//last
